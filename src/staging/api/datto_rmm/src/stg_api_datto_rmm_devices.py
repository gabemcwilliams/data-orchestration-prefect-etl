...
# Collect results from each task for CLI feedback
results_list = []
...
def stg_api_datto_rmm_devices() -> None:
    ...
    # Final output print block for CLI review
    print("#" * 75)
    print("\n        FINAL RESULTS\n")
    print("--------------------------------")
